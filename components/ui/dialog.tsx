...
>(({ className, children, hasCloseIcon, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        `fixed bottom-0 z-modal flex w-full max-w-[380px] flex-col items-center justify-center gap-4 rounded-t-xl border bg-customBackground-secondary px-[16px] pb-[32px] ${hasCloseIcon ? 'pt-[16px]' : 'pt-[32px]'} shadow-lg max-md:left-0 max-md:right-0 max-md:mx-auto ${mdAnimation} ${commonAnimation}`,
        className
      )}
      {...props}
    >
